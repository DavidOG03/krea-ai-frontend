...
export default function Home() {
  ...
  const items = [
    ...
    },
    {
      ...
      title: "Video",
      isNew: false,
      text: "Generate videos with Haiku, Pika, Runway, Luma, and more.",
      style:
        "relative aspect-square rounded-[10px] bg-[oklch(79.55%_0.1875_75.3501)] inset-ring-[0.5px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_1px_5px_rgba(255,255,255,0.1)] inset-ring-black/10 size-10.5 shrink-0",
    },
    {
      id: 3,
      icon: (
    ...
    },
    {
      ...
      title: "Enhancer",
      isNew: true,
      text: "Upscale and enhance images and videos up to 2K.",
      style:
        "relative aspect-square rounded-[10px] inset-ring-[0.5px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_1px_5px_rgba(255,255,255,0.1)] inset-ring-black/10 size-10.5 shrink-0",
      css: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {items.map((item, idx) => (
                <FeatureCard
                  ...
                  text={item.text}
                  isNew={item.isNew}
                  tailwindStyle={item.style}
                  customStyle={item.css}
                />
              ))}
            </div>
          </div>
